...
@Slf4j
public class CTRDRBGSecureRandomV1 extends SecureRandom {
   ...
   */
  public CTRDRBGSecureRandomV1(byte[] personalizationString) throws NoSuchAlgorithmException {
   ...
   */
  public CTRDRBGSecureRandomV1(int requestedSecurityStrength, byte[] personalizationString) throws NoSuchAlgorithmException {
