...
public final class SQLOperatorFormat {
  ...
  public static final String JSON_EXISTS_FORMAT = "%s ? #{simpleConditions[%d].value}";
  public static final String JSON_EXISTS_ANY_FORMAT = "%s ?| #{simpleConditions[%d].value}";
  public static final String JSON_EXISTS_ALL_FORMAT = "%s ?& #{simpleConditions[%d].value}";
