...
import org.example.websocketdemo1.handler.PointToPointChatTextWebSocketHandler;
...
public class WebSocketConfig implements WebSocketConfigurer {
  ...
  public void registerWebSocketHandlers(WebSocketHandlerRegistry registry) {
    ...
    registry.addHandler(new PointToPointChatTextWebSocketHandler(), "/ws/point-to-point-chat").setAllowedOrigins("*");
