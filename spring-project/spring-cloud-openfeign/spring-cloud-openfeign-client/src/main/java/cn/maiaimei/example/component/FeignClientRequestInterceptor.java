...
@Slf4j
public class FeignClientRequestInterceptor extends Client.Default implements RequestInterceptor {
    private static final String TRACE_ID = "traceId";

    public FeignClientRequestInterceptor(SSLSocketFactory sslContextFactory, HostnameVerifier hostnameVerifier) {
...
//        String url = String.format("%s%s", requestTemplate.feignTarget().url(), requestTemplate.url());
//        String bodyAsString = requestTemplate.body() != null ? new String(requestTemplate.body(), StandardCharsets.UTF_8) : "";
//        log.info("url: {}, method: {}, headers: {}, payload: {}",
//                url, requestTemplate.method(), requestTemplate.headers(), bodyAsString);
    }
