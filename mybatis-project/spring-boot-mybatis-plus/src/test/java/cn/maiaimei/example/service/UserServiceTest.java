...
class UserServiceTest extends TestBase {
    ...
    void testPageQuery() {
        ...
        PaginationResult<UserResponse> expected = readFileAsObject(PAGE_QUERY_USER_RESPONSE, new TypeReference<PaginationResult<UserResponse>>() {
        });
        ...
        PaginationResult<UserResponse> actual = userService.pageQuery(1, 3, request);
