...
public class UserService extends ServiceImpl<UserMapper, User> {
    ...
    public PaginationResult<UserResponse> pageQuery(Integer current, Integer size, UserQueryRequest userQueryRequest) {
        ...
        return PaginationUtils.build(page, UserResponse.class);
    }
}
